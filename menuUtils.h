...
void printTeamInfo(void){
    ...
    std::cout << "\t [1] Maxwell Adam (s4022483@student.rmit.com)" << std::endl;
    std::cout << "\t [2] Jimmy Vu (s4006701@student.rmit.edu.au)" << std::endl;
    std::cout << "\t [3] Riveen Perera (s3896471@student.rmit.edu.au)" << std::endl;
    //*************
